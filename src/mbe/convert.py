...
class ConvertConfig:
    ...
    # Same, on the basis axis: force every bank to this many bases, keeping
    # the rule's T_j. Set to the rule's cap (4) for the N-matched ablation.
    pasn_n_fixed: int | None = None
...
def _routed_primitive(name, domain, e_min, e_max, cfg: ConvertConfig,
    ...
    return build_mbe_pasn(
        ...
        t_fixed=cfg.pasn_t_fixed, n_fixed=cfg.pasn_n_fixed,
